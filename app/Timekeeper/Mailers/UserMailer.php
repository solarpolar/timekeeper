<?php namespace Timekeeper\Mailers;
...
class UserMailer extends Mailer {
	...
	{
		$events->listen('user.signup', 		'Timekeeper\Mailers\UserMailer@welcome');
		$events->listen('user.resend', 		'Timekeeper\Mailers\UserMailer@welcome');
		$events->listen('user.forgot',      'Timekeeper\Mailers\UserMailer@forgotPassword');
		$events->listen('user.newpassword', 'Timekeeper\Mailers\UserMailer@newPassword');
	}
